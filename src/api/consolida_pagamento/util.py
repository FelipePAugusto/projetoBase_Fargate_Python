...
#             "X-License-Key": os.environ.get("NEW_RELIC_LICENSE_KEY"),
#             "Accept": "*/*",
...
#         r = requests.post(
#             os.environ.get("NEW_RELIC_LOG_API"), json=payload, headers=headers
#         )
...
# async def set_consolidado_error(
#     *,
#     info: str = None,
#     fonte_id: int = None,
#     filial: str = None,
...
#         if (
#             info is not None
#             and fonte_id is not None
#             and filial is not None
#             and data_recebimento is not None
#         ):
...
#     tipo: str,
#     tag_formula: str,
#     is_coluna_virtual: bool = False,
#     pgtos_analitico: dict = None,
# ):
#     valor = None
#     corrige_dados = {}
...
#     for key in dado:
#         corrige_dados[
#             remove_accents(key.upper().replace(" ", "_")).decode("utf-8")
#         ] = dado[key]
...
#             if (
#                 valor is not None
#                 and condicao_operador is not None
#                 and condicao_valor is not None
#             ):
#                 if num_cond(corrige_dados, condicao_operador, condicao_valor) is False:
#                     valor = corrige_dados
#         else:
...
#                 and condicao_valor is not None
#             ):
#                 if num_cond(condicao_operador, "|>", "CD"):
#                     if (
#                         num_cond(
#                             corrige_dados,
#                             condicao_operador,
...
#                     ):
#                         valor = corrige_dados
#                 if num_cond(condicao_operador, "|>", "⊇A") or num_cond(
#                     condicao_operador, "|>", "⊉A"
#                 ):
#                     if (
#                         num_cond(valor, condicao_operador, condicao_valor, delimitador)
#                         is False
#                     ):
#                         valor = corrige_dados
#                 if num_cond(condicao_operador, "|>", "T"):
#                     if (
#                         num_cond(valor, condicao_operador, condicao_valor, delimitador)
#                         is False
#                     ):
...
#     dado_new = {}
#     for key in dado:
#         dado_new[remove_accents(key.upper().replace(" ", "_")).decode("utf-8")] = dado[
#             key
#         ]

#     if len(condicoes) > 2 and condicoes[2]:
#         if (
#             condicoes[2]["condicao_tipo"] == "AND"
#             and condicoes[1]["condicao_tipo"] == "AND"
#         ):
#             cond_0 = await num_cond(
#                 dado_new.get(condicoes[0]["cabecalho_nome"]),
#                 condicoes[0]["sinal_tipo"],
#                 condicoes[0]["resultado_valor"],
#             )
#             cond_1 = await num_cond(
#                 dado_new.get(condicoes[1]["cabecalho_nome"]),
#                 condicoes[1]["sinal_tipo"],
#                 condicoes[1]["resultado_valor"],
#             )
#             cond_2 = await num_cond(
#                 dado_new.get(condicoes[2]["cabecalho_nome"]),
#                 condicoes[2]["sinal_tipo"],
#                 condicoes[2]["resultado_valor"],
#             )
...
#         elif (
#             condicoes[2]["condicao_tipo"] == "AND"
#             and condicoes[1]["condicao_tipo"] == "OR"
#         ):
#             cond_0 = await num_cond(
#                 dado_new.get(condicoes[0]["cabecalho_nome"]),
#                 condicoes[0]["sinal_tipo"],
